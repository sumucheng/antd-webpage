export default {
    react: [
        ...
        },
        {
            ...
            detail: '使用 react 实现的计算器，可以计算加减乘除'
        },
        {
            name: 'pomodoro',
            displayName: '番茄钟',
            ...
            detail: '使用 react 实现的番茄钟，可以实现计时、暂停、增减时间、统计今日番茄时间等功能'
        },
        {
            name: 'tictactoe',
            displayName: '井字棋',
    ...
    vue: [
        {
            ...
            detail: '使用 Vue2 + TypeScript3 + Vuex3 + Vue Router3 实现的记账软件，使用 LocalStorage 作为本地数据库，统计图表使用阿里的 AntV G2 可视化引擎完成，功能包括记账、查看流水、查看统计、标签管理、年账单、预算管理等'
        },
        {
            name: 'vue',
